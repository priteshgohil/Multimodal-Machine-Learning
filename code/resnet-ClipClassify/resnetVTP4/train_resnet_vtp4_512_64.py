...
from fusionNet_512_64 import FusionNet
import torch.nn as nn
import torch
import resnet
import tactileNet_512_64 as tactileNet
...
#            pretrain = torch.load("../../../out/resnet/resnet-18-kinetics.pth", map_location="cpu")
        ...
        tp_net = tactileNet.tactileNet()


        net = FusionNet(sm, tp_net)
        if torch.cuda.is_available():
            net.cuda()
    ...
    def train(self):
        ...
        for epoch in range(epoch_num):
            ...
            for i,data in enumerate(self.dataloader):
                vid, tp_early_fused, lab, path = data
                ...
                out = self.model(video.float(),tp_fused.float())
                out = out.squeeze(1)
    ...
    def test(self):
        ...
        for index in range(video_num):
            ...
            for i,dota in enumerate(packed_data):
                video, tp_early_fused, label = dota
