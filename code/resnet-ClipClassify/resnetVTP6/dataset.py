...
class VisualTactile(data.Dataset):
    ...
    def __getitem__(self,clip_index):
        ...
        clip, fused_tp, label = self.custom_getitem(front_vid_path, vid_frames, label, tac_path, pos_path, tac_frames)
        return clip, fused_tp, label, label_path
    ...
    def custom_getitem(self,front_vid_path, vid_frames, label, tac_path=None, pos_path=None, tac_frames=None):
        ...
        return video_to_tensor(clip), video_to_tensor(tp_fused), torch.from_numpy(label)
