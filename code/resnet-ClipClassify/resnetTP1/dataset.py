...
class VisualTactile(data.Dataset):
    ...
    def __getitem__(self,clip_index):
        ...
        tactile, position, label = self.custom_getitem(label, tac_path, pos_path, tac_frames)
        return tactile, position, label, label_path
    ...
    def custom_getitem(self, label, tac_path=None, pos_path=None, tac_frames=None):
        ...
        return video_to_tensor(tactile),video_to_tensor(position), torch.from_numpy(label)
