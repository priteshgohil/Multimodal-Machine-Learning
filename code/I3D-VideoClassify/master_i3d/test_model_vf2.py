...
from visual_tactile_dataset_vf import VisualTactile as Dataset
import cv2
...
def run(init_lr=0.01, max_steps=30, mode='rgb', root='/media/pritesh/Entertainment/Visual-Tactile_Dataset/dataset/',\
    ...
    writer = tensorboardX.SummaryWriter(comment="testvf2")
    # setup dataset
...
#         optimizer.zero_grad()
        ...
        for data in dataloaders[phase]:
            num_iter += 1
            # get the inputs
            f_vid, l_vid, tactile, pos, labels, f_flow, l_flow, directory = data
