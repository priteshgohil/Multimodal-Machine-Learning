...
def run(init_lr=0.01, max_steps=30, mode='rgb', root='/media/pritesh/Entertainment/Visual-Tactile_Dataset/dataset/',\
        train_split='train.txt', test_split='test.txt', batch_size=15, save_model=''):
    writer = tensorboardX.SummaryWriter(comment="V.testTrainv3.lr0.01.batch20.epoch30.resize112")
    # setup dataset
