...
def normalize_multichannel(np_array_input):
    '''
    To noramalize sensor data into range of -1 to 1
    '''
    normalized = np_array_input / np.linalg.norm(np_array_input)
